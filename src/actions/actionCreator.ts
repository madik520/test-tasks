...
export const fetchAllCharacters = createAsyncThunk(charactersConstants.getCharacter, async () => {
	return await fetchApi();
});

export const getUserByName = createAsyncThunk(charactersConstants.getCharacterByName, async (name: string) => {
